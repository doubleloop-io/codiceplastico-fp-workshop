...
object OptionFutureDemo {
  ...
  implicit val optionFutureMonad: _root_.cats.Monad[_root_.demos.OptionFutureDemo.OptionFuture]
    with _root_.cats.StackSafeMonad[_root_.demos.OptionFutureDemo.OptionFuture] = new Monad[OptionFuture]
